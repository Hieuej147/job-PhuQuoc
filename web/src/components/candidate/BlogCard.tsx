...
export default function BlogCard({ blog }: BlogCardProps) {
    return (
        <div className="bg-white rounded-xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col h-full group relative">
            ...
            <div className="h-44 w-full bg-slate-100 overflow-hidden relative">
                ...
                <span className={`absolute top-3 left-3 text-white text-[10px] font-bold px-2 py-0.5 rounded-md z-20 flex items-center gap-1 ${blog.uiCatBg}`}>
                    {blog.categorySlug === "bi-quyet-tim-viec" ? "🎓" : "📈"} {blog.categoryName}
                </span>
                <img
            ...
            <div className="p-4 flex flex-col flex-grow justify-between relative z-0">
                <div>
                    <h3 className="font-bold text-slate-800 text-[14px] leading-snug group-hover:text-[#0891b2] transition-colors line-clamp-2 min-h-[40px]">
                        {blog.title}
                    </h3>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex flex-col gap-2 relative z-20">
                    <div className="flex items-center justify-between text-slate-400 text-[11px]">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-medium text-slate-600">{blog.authorName}</span>
                        </div>
                    ...
                    <span className="text-[12px] font-bold text-[#0891b2] group-hover:text-[#025a70] mt-1 inline-flex items-center gap-0.5 transition-colors">
