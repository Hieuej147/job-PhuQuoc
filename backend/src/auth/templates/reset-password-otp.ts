    ...
    <tr>
      <td align="center">
        <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;padding:32px;max-width:500px">
          <tr>
            <td>
              <h2 style="margin:0 0 16px;color:#1a1a1a;font-size:24px">Đặt lại mật khẩu</h2>
              <p style="margin:0 0 24px;color:#333;font-size:16px;line-height:24px">
                Bạn đã yêu cầu đặt lại mật khẩu. Mã OTP của bạn:
              </p>
              ...
              <p style="margin:0 0 8px;color:#999;font-size:12px;line-height:16px">
                Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.
              </p>
              <p style="margin:0;color:#999;font-size:12px;line-height:16px">
                Mật khẩu của bạn sẽ không thay đổi cho đến khi bạn nhập OTP và tạo mật khẩu mới.
              </p>
